...
class CurrencyHelper {
    public static function currencyMaster() {
        $currencies = [
            ...
            "BAM" => ["Bosnia and Herzegovina", "Bosnia-Herzegovina Convertible Mark"],
            ...
            "SLL" => ["Sierra Leone", "Sierra Leonean Leone (Old)"],
            "SOS" => ["Somalia", "Somali Shilling"],
            "SRD" => ["Suriname", "Surinamese Dollar"],
            "STD" => ["São Tomé and Príncipe", "São Tomé and Príncipe Dobra (Old)"],
            "SVC" => ["El Salvador", "Salvadoran Colón"],
            ...
            "XDR" => ["IMF", "IMF Special Drawing Rights"],
            "XOF" => ["WAEMU", "West African CFA Franc"],
            "XPF" => ["French Territories", "CFP Franc"],
            "YER" => ["Yemen", "Yemeni Rial"],
            "ZAR" => ["South Africa", "South African Rand"],
            "ZMK" => ["Zambia (Old)", "Zambian Kwacha (Old)"],
